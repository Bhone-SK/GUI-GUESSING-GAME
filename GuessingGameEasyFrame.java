/**
 * A guessing game in GUI. An easy version where the user is given hints.
...
public class GuessingGameEasyFrame extends JFrame
{
	...
	public GuessingGameEasyFrame()
	{
		setTitle("This is an easy guessing game. Can you pass?");
	...
	public void createDiscription()
	{
		...
		discription.setText("                           This is a guessing game. Don't worry, it's the easy one." + "\n");
		discription.append("                                                I hope you are ready for a big war!" + "\n");
		discription.append("                     You guess a number between 1 - 10. There will be hints to guide you." + "\n");
	...
	class ClickListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			else
			{
				...
				if (guess > correctNum)
				{
					messagesAfterGuess.setText("Too high. Kitty is sad......");
				}
				else
				{
					messagesAfterGuess.setText("Too low. Kitty is sad......");//Enter an integer is supposed to display if the input is not an integer. Not this.
				}
			}
		}
	}
